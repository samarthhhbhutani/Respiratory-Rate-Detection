...
if __name__ == "__main__":
    ...
    while cap.isOpened() and frame_count < NUM_FRAMES:
        ...
        # chest_vid[frame_count][:] = uint8_to_float(gray[chest_coords[1]:chest_coords[3],chest_coords[0]:chest_coords[2]])
    ...
    chest_motion_2d, chest_motion = track_motion(chest_vid, frame_count)
    ...
    lowpass_thresh = np.max(remove_outliers(filtered_chest_motion)) * 0.4
